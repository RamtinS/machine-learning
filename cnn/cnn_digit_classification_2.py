...
class ConvolutionalNeuralNetworkModel(nn.Module):
    def __init__(self):
        ...
        # First convolution layer: 1 input channel and 32 output channels (feature maps of size 28x28).
        self.conv1 = nn.Conv2d(1, 32, kernel_size=5, padding=2)
        # First pooling layer: Reduce the size of the maps to 14x14.
        self.pool1 = nn.MaxPool2d(kernel_size=2)
        # Second convolution layer: 32 input channels and 64 output channels (feature maps of size 14x14).
        self.conv2 = nn.Conv2d(32, 64, kernel_size=5, padding=2)
        # Second pooling layer: Reduce the size of the maps to 7x7.
